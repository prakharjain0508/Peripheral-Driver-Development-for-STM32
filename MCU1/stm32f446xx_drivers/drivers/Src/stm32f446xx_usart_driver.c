 ...
 *
 * @brief             - This function enables or disables USARTx peripheral clock
 *
 ...
 *
 * @brief             - This function is used to enable or disable the USARTx peripheral
 *
 * @param[in]         - base address of USARTx peripheral
 * @param[in]         - ENABLE or DISABLE macros
 *
 ...
 * @fn      		  - USART_Init
 *
 * @brief             -	Send data from the given USARTx peripheral
 *
 ...
 * @fn      		  - USART_DeInit
 *
 * @brief             - This function de-initializes the given USARTx peripheral
 *
 * @param[in]         - base address of USARTx peripheral
 *
 * @return            - none
 ...
 *
 * @brief             - Receive data from the given USARTx peripheral
 *
 * @param[in]         - base address of USARTx peripheral
 ...
 * @fn      		  - USART_SendDataIT
 *
 * @brief             - Send data from the given USARTx peripheral using USARTx Interrupt
 *
 * @param[in]         - handle structure for USARTx peripheral
 * @param[in]         - pointer to transfer buffer
 * @param[in]         - size of data transfer (in bytes)
 *
 * @return            - state
 ...
 *
 * @brief             - sets the baud rate of Tx/Rx
 *
 * @param[in]         - base address of USARTx peripheral
 ...
 * @fn      		  - USART_ClearFlag
 *
 * @brief             - clears flag in the status register
 *
 * @param[in]         - base address of USARTx peripheral
 * @param[in]         - name of the flag
 *
 ...
 *
 * @brief             - This function configures the given IRQ number of the USARTx peripheral
 *
 ...
 *
 * @brief             - This function processes the occurred interrupts generated by USARTx events
 *
 * @param[in]         - handle structure for USARTx peripheral
 *
 *
