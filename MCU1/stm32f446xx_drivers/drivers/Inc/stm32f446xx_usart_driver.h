...
typedef struct
{
	USART_RegDef_t *pUSARTx;				/* This holds the base address of USARTx(x: 0,1,2,3,4,5) peripheral */
	USART_Config_t USART_Config; 			/* This holds the USARTx peripheral configuration settings */
